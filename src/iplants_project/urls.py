...
urlpatterns = [
    ...
    path("detail/metabolite/<str:metid>", get_metabolite_detail_view),
    path("detail/reaction/<str:reacid>", get_reaction_detail_view),
    path("detail/enzyme/<str:enzid>", get_enzyme_detail_view),
    path("detail/gene/<str:geneid>", get_gene_detail_view),
    path("detail/pathway/<str:pathid>", get_pathway_detail_view),
    path("detail/organism/<str:orgid>", get_organism_detail_view),
    path("detail/metabolicmodel/<str:modelid>", get_metabolicmodel_detail_view),
